...
const ProfileCard: React.FC<ProfileCardProps> = ({ values, onEdit }) => {
  ...
  return (
    <div>
      <div
        ref={profileCardRef}
        className="flex flex-col items-center p-4 space-y-4 bg-white shadow-md rounded-md"
      >
        {/* Start of profile card */}
        <h2 className="text-2xl Tajawal font-bold text-center">
          {t("profile")}
        </h2>
      ...
      <div className="flex justify-center gap-10 mt-4">
        ...
        <DownloadPDFButton targetRef={profileCardRef} />
      </div>
    </div>
  );
};
